...
use aegis_core::{Channel, ChannelKind, Message, Result, AgentRegistry, StorageBackend};
...
impl BroadcastChannel {
    pub fn new(name: String, registry: Arc<dyn AgentRegistry>, storage: Arc<dyn StorageBackend>) -> Self {
        Self { name, registry, storage }
    }
}
